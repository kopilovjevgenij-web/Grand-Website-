...
var reviews = [
  ...
  },
  {
    author: "Алла Ершова",
    rating: 5,
    text: "Праздновали день рождения в ресторане \"Grand\".Все понравилось.все было вкусно.обслуживание отличное.очень внимательный официант. ему отдельная благодарность.Музыку. .может для нас так.хотелось пошустрее.Отдельная благодарность от Ирины Молодцы.",
    date: "4 месяца назад",
  },
  {
    author: "Sofija",
    rating: 5,
    text: "Я София, мне 9 лет, были у бабушки на юбилее . Мне очень очень понравился музыкант, мы круто протанцевали. Еда была очень вкусненькой . И девочки официанты очень красивые. Спасибо!",
    date: "5 месяцев назад",
  },
  {
    author: "Ирина Ермолаева",
    rating: 5,
    text: "Искренние слова благодарности за посещение кафе\"Grand restoran\",где атмосфера уюта и тепла побуждают гостей вернуться снова,Ключевые моменты:Вкусная еда,вежливый персонал,уютная атмосфера и чистота,Большое спасибо за юбилей 70 лет,которое гуляли 4апреля.",
    date: "5 месяцев назад",
  },
  {
    author: "Клавдия Юраш",
    rating: 5,
    text: "Уважаемая команда кафе \"Grand Restaurant\" ,благадарю за уютную атмосферу, вкусную еду и профиссиональное обслуживание, что сделали мой юбилей незабываемым. Спасибо за слаженную работу команды и за гостиприимство, благадаря которым, гости чувствовали себя комфортно.",
    date: "5 месяцев назад",
  },
  {
    author: "zanna butkevica",
    rating: 5,
    text: "Очень приятно были удивлены! Прекрасное обслуживание! Молодые работники, приветливые! Еда вкусная и очень большие порции за очень приятную цены! Обязательно всем посоветуем и вернёмся опять!",
    date: "4 месяца назад",
  },
  {
    author: "bully zpchwc",
    rating: 5,
    text: "Приходили сегодня на комплексные обеды все было действительно вкусно, круто и приятно. Начиная от обслуживания, заканчивая едой",
    date: "5 месяцев назад",
  },
];
